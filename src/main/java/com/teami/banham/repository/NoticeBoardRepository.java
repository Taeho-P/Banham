...
public interface NoticeBoardRepository extends JpaRepository<NoticeBoardEntity, Long>, JpaSpecificationExecutor<NoticeBoardEntity> {

    Optional<NoticeBoardEntity> findByBno(Long bno); //게시글 고유번호를 통해 특정 게시글을 조회해주는 메소드


    Page<NoticeBoardEntity> findAll(Specification<NoticeBoardEntity> spec, Pageable pageable);
