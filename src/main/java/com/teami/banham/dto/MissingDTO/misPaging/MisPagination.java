...
public class MisPagination {
    ...
    public MisPagination(int totalRecordCount, MisCommonParams params) {
        if (totalRecordCount > 0) {
            this.totalRecordCount = totalRecordCount;
            calculation(params);
            params.setMisPagination(this);
        }
    }

    private void calculation(MisCommonParams params) {
